...
public class ManageResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manage_results);
        ...
        participantNames.add("1h 10 minutes");
        participantNames.add("5h 25 minutes");
        participantNames.add("63 minutes");
